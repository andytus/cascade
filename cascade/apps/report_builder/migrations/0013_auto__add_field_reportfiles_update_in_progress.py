...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportFiles.update_in_progress'
        db.add_column(u'report_builder_reportfiles', 'update_in_progress',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportFiles.update_in_progress'
        db.delete_column(u'report_builder_reportfiles', 'update_in_progress')
    ...
    models = {
        ...
        u'report_builder.reportfiles': {
            ...
            'update_in_progress': ('django.db.models.fields.CharField', [], {'default': "'No'", 'max_length': '4'})
        },
        u'sites.site': {
