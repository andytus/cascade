...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field site on 'Report'
        db.create_table(u'report_builder_report_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'report_builder.report'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'report_builder_report_site', ['report_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field site on 'Report'
        db.delete_table('report_builder_report_site')
