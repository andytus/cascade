...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportFiles'
        db.create_table(u'report_builder_reportfiles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_file', to=orm['report_builder.Report'])),
            ('file_extension', self.gf('django.db.models.fields.CharField')(default='xlsx', max_length=8)),
            ('file_path', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
            ('last_generated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('last_generated_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal(u'report_builder', ['ReportFiles'])

        # Deleting field 'Report.last_generated'
        db.delete_column(u'report_builder_report', 'last_generated')

        # Deleting field 'Report.report_generated_to'
        db.delete_column(u'report_builder_report', 'report_generated_to')


    def backwards(self, orm):
        # Deleting model 'ReportFiles'
        db.delete_table(u'report_builder_reportfiles')

        # Adding field 'Report.last_generated'
        db.add_column(u'report_builder_report', 'last_generated',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Report.report_generated_to'
        db.add_column(u'report_builder_report', 'report_generated_to',
    ...
    models = {
        ...
        u'report_builder.reportfiles': {
            'Meta': {'object_name': 'ReportFiles'},
            'file_extension': ('django.db.models.fields.CharField', [], {'default': "'xlsx'", 'max_length': '8'}),
            'file_path': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_generated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_generated_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'report_file'", 'to': u"orm['report_builder.Report']"}),
