...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'cartmanager_useraccountprofile')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cartmanager_useraccountprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('company', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'cartmanager', ['UserAccountProfile'])

        # Adding M2M table for field sites on 'UserAccountProfile'
        db.create_table(u'cartmanager_useraccountprofile_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('useraccountprofile', models.ForeignKey(orm[u'cartmanager.useraccountprofile'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'cartmanager_useraccountprofile_sites', ['useraccountprofile_id', 'site_id'])
