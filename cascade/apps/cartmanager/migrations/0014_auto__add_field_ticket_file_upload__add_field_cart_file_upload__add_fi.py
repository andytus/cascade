...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.file_upload'
        db.add_column('cartmanager_ticket', 'file_upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tickets_upload_file', null=True, to=orm['cartmanager.TicketsCompleteUploadFile']),
                      keep_default=False)

        # Adding field 'Cart.file_upload'
        db.add_column('cartmanager_cart', 'file_upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cart_upload_file', null=True, to=orm['cartmanager.CartsUploadFile']),
                      keep_default=False)

        # Adding field 'CollectionCustomer.file_upload'
        db.add_column('cartmanager_collectioncustomer', 'file_upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='customers_upload_file', null=True, to=orm['cartmanager.CustomersUploadFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.file_upload'
        db.delete_column('cartmanager_ticket', 'file_upload_id')

        # Deleting field 'Cart.file_upload'
        db.delete_column('cartmanager_cart', 'file_upload_id')

        # Deleting field 'CollectionCustomer.file_upload'
        db.delete_column('cartmanager_collectioncustomer', 'file_upload_id')
