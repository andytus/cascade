...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollectionAddress.suffix'
        db.add_column(u'cartmanager_collectionaddress', 'suffix',
        ...
        # Adding field 'InventoryAddress.suffix'
        db.add_column(u'cartmanager_inventoryaddress', 'suffix',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'CollectionAddress.suffix'
        db.delete_column(u'cartmanager_collectionaddress', 'suffix')

        # Deleting field 'CollectionAddress.street_direction'
        db.delete_column(u'cartmanager_collectionaddress', 'street_direction')

        # Deleting field 'InventoryAddress.suffix'
        db.delete_column(u'cartmanager_inventoryaddress', 'suffix')
    ...
    models = {
        ...
        u'cartmanager.collectionaddress': {
            ...
            'street_direction': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
