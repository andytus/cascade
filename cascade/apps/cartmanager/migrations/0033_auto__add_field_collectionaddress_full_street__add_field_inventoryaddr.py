...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollectionAddress.full_street'
        db.add_column(u'cartmanager_collectionaddress', 'full_street',
                      self.gf('django.db.models.fields.CharField')(default='calculate full street', max_length=200),
                      keep_default=False)

        # Adding field 'InventoryAddress.full_street'
        db.add_column(u'cartmanager_inventoryaddress', 'full_street',
                      self.gf('django.db.models.fields.CharField')(default='calculate full street', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollectionAddress.full_street'
        db.delete_column(u'cartmanager_collectionaddress', 'full_street')

        # Deleting field 'InventoryAddress.full_street'
        db.delete_column(u'cartmanager_inventoryaddress', 'full_street')
    ...
    models = {
        ...
        u'cartmanager.collectionaddress': {
            'Meta': {'unique_together': "(('house_number', 'street_name', 'unit', 'direction', 'suffix'),)", 'object_name': 'CollectionAddress'},
            ...
            'full_street': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
