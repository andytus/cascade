...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cartmanager_ticket', 'comment_id')

        # Adding field 'TicketComments.ticket'
        db.add_column('cartmanager_ticketcomments', 'ticket',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ticket', to=orm['cartmanager.Ticket']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ticket.comment'
        db.add_column('cartmanager_ticket', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cartmanager.TicketComments'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TicketComments.ticket'
        db.delete_column('cartmanager_ticketcomments', 'ticket_id')
    ...
    models = {
        ...
        'cartmanager.ticketcomments': {
            ...
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ticket'", 'to': "orm['cartmanager.Ticket']"})
        },
