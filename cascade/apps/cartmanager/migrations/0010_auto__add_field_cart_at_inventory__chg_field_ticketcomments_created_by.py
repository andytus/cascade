...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.at_inventory'
        db.add_column('cartmanager_cart', 'at_inventory',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'TicketComments.created_by'
        db.alter_column('cartmanager_ticketcomments', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Cart.at_inventory'
        db.delete_column('cartmanager_cart', 'at_inventory')


        # Changing field 'TicketComments.created_by'
        db.alter_column('cartmanager_ticketcomments', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
