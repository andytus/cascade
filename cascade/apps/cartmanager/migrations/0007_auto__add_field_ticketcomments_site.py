...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketComments.site'
        db.add_column('cartmanager_ticketcomments', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketComments.site'
        db.delete_column('cartmanager_ticketcomments', 'site_id')
