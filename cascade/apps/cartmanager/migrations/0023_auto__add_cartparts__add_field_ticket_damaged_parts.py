...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CartParts'
        db.create_table(u'cartmanager_cartparts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('on_hand', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'cartmanager', ['CartParts'])

        # Adding M2M table for field site on 'CartParts'
        db.create_table(u'cartmanager_cartparts_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cartparts', models.ForeignKey(orm[u'cartmanager.cartparts'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'cartmanager_cartparts_site', ['cartparts_id', 'site_id'])

        # Adding M2M table for field site on 'CartServiceCharge'
        db.create_table(u'cartmanager_cartservicecharge_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cartservicecharge', models.ForeignKey(orm[u'cartmanager.cartservicecharge'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'cartmanager_cartservicecharge_site', ['cartservicecharge_id', 'site_id'])

        # Adding field 'Ticket.damaged_parts'
        db.add_column(u'cartmanager_ticket', 'damaged_parts',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='damaged_parts', null=True, to=orm['cartmanager.CartParts']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CartParts'
        db.delete_table(u'cartmanager_cartparts')

        # Removing M2M table for field site on 'CartParts'
        db.delete_table('cartmanager_cartparts_site')

        # Removing M2M table for field site on 'CartServiceCharge'
        db.delete_table('cartmanager_cartservicecharge_site')
    ...
    models = {
        ...
        u'cartmanager.ticket': {
            ...
            'damaged_parts': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'damaged_parts'", 'null': 'True', 'to': u"orm['cartmanager.CartParts']"}),
