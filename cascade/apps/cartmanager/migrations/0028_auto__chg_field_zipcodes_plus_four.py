...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ZipCodes.plus_four'
        db.alter_column(u'cartmanager_zipcodes', 'plus_four', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'ZipCodes.plus_four'
        db.alter_column(u'cartmanager_zipcodes', 'plus_four', self.gf('django.db.models.fields.CharField')(default=0, max_length=4))
