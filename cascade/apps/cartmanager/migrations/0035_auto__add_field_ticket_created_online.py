...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.created_online'
        db.add_column(u'cartmanager_ticket', 'created_online',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.created_online'
        db.delete_column(u'cartmanager_ticket', 'created_online')
