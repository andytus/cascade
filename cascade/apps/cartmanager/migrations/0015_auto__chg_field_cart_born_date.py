...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cart.born_date'
        db.alter_column('cartmanager_cart', 'born_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cart.born_date'
        db.alter_column('cartmanager_cart', 'born_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 9, 0, 0)))
