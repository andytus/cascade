...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.route'
        db.add_column('cartmanager_ticket', 'route',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ticket_route', null=True, to=orm['cartmanager.Route']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.route'
        db.delete_column('cartmanager_ticket', 'route_id')
