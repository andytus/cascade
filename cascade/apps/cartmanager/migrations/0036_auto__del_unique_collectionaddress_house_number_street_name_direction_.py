...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CollectionAddress', fields ['house_number', 'street_name', 'direction', 'unit', 'suffix']
        db.delete_unique(u'cartmanager_collectionaddress', ['house_number', 'street_name', 'direction', 'unit', 'suffix'])

        # Adding unique constraint on 'CollectionAddress', fields ['house_number', 'city', 'street_name', 'unit']
        db.create_unique(u'cartmanager_collectionaddress', ['house_number', 'city', 'street_name', 'unit'])


    def backwards(self, orm):
        # Removing unique constraint on 'CollectionAddress', fields ['house_number', 'city', 'street_name', 'unit']
        db.delete_unique(u'cartmanager_collectionaddress', ['house_number', 'city', 'street_name', 'unit'])

        # Adding unique constraint on 'CollectionAddress', fields ['house_number', 'street_name', 'direction', 'unit', 'suffix']
        db.create_unique(u'cartmanager_collectionaddress', ['house_number', 'street_name', 'direction', 'unit', 'suffix'])
    ...
    models = {
        ...
        u'cartmanager.carttype': {
            'Meta': {'ordering': "['-name', '-size']", 'unique_together': "(('name', 'size'),)", 'object_name': 'CartType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cartmanager.collectionaddress': {
            'Meta': {'unique_together': "(('house_number', 'street_name', 'unit', 'city'),)", 'object_name': 'CollectionAddress'},
            ...
            'direction': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            ...
            'property_type': ('django.db.models.fields.CharField', [], {'default': "'Residential'", 'max_length': '25', 'null': 'True', 'blank': 'True'}),
            ...
            'suffix': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
        ...
        u'cartmanager.collectioncustomer': {
            ...
            'first_name': ('django.db.models.fields.CharField', [], {'default': "'RESIDENT'", 'max_length': '25', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'default': "'RESIDENT'", 'max_length': '50', 'null': 'True'}),
        ...
        u'cartmanager.route': {
            'Meta': {'unique_together': "(('route', 'route_day', 'route_type'),)", 'object_name': 'Route'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cartmanager.ticket': {
            ...
            'created_online': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'cartmanager.zipcodes': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plus_four': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
