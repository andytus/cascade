...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'cartmanager_inventoryaddress', ['house_number', 'street_name', 'unit'])

        # Adding model 'CartServiceCharge'
        db.create_table(u'cartmanager_cartservicecharge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('currency', self.gf('django.db.models.fields.CharField')(default='US Dollars', max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
        ))
        db.send_create_signal(u'cartmanager', ['CartServiceCharge'])

        # Adding field 'CartServiceType.default_charge'
        db.add_column(u'cartmanager_cartservicetype', 'default_charge',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_charge', null=True, to=orm['cartmanager.CartServiceCharge']),
                      keep_default=False)

        # Adding field 'Ticket.charge'
        db.add_column(u'cartmanager_ticket', 'charge',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CartServiceCharge'
        db.delete_table(u'cartmanager_cartservicecharge')

        # Deleting field 'CartServiceType.default_charge'
        db.delete_column(u'cartmanager_cartservicetype', 'default_charge_id')

        # Deleting field 'Ticket.charge'
        db.delete_column(u'cartmanager_ticket', 'charge')

        # Adding unique constraint on 'InventoryAddress', fields ['house_number', 'street_name', 'unit']
        db.create_unique(u'cartmanager_inventoryaddress', ['house_number', 'street_name', 'unit'])
