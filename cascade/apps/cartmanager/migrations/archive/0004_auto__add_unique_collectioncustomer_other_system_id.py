...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CollectionCustomer', fields ['other_system_id']
        db.create_unique('cartmanager_collectioncustomer', ['other_system_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CollectionCustomer', fields ['other_system_id']
        db.delete_unique('cartmanager_collectioncustomer', ['other_system_id'])
