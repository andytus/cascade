...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'cartmanager_collectionaddress', ['house_number', 'street_name', 'unit'])
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'cartmanager_collectionaddress', ['house_number', 'street_name', 'unit'])
