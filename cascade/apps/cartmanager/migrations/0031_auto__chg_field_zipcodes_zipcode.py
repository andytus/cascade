...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ZipCodes.zipcode'
        db.alter_column(u'cartmanager_zipcodes', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'ZipCodes.zipcode'
        db.alter_column(u'cartmanager_zipcodes', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=5))
