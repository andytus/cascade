...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RouteUploadFile'
        db.create_table('cartmanager_routeuploadfile', (
        ...
        db.send_create_signal('cartmanager', ['RouteUploadFile'])


    def backwards(self, orm):
        # Deleting model 'RouteUploadFile'
        db.delete_table('cartmanager_routeuploadfile')
