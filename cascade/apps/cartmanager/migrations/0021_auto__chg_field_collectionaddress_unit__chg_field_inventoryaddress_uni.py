...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cartmanager_collectionaddress', 'unit', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

        # Changing field 'InventoryAddress.unit'
        db.alter_column('cartmanager_inventoryaddress', 'unit', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

    def backwards(self, orm):

        # Changing field 'CollectionAddress.unit'
        db.alter_column('cartmanager_collectionaddress', 'unit', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'InventoryAddress.unit'
        db.alter_column('cartmanager_inventoryaddress', 'unit', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        'cartmanager.ticket': {
            ...
            'route': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ticket_route'", 'null': 'True', 'to': "orm['cartmanager.Route']"}),
