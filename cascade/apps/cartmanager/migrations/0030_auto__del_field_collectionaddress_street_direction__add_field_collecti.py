...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CollectionAddress.street_direction'
        db.delete_column(u'cartmanager_collectionaddress', 'street_direction')

        # Adding field 'CollectionAddress.direction'
        db.add_column(u'cartmanager_collectionaddress', 'direction',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InventoryAddress.street_direction'
        db.delete_column(u'cartmanager_inventoryaddress', 'street_direction')

        # Adding field 'InventoryAddress.direction'
        db.add_column(u'cartmanager_inventoryaddress', 'direction',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CollectionAddress.street_direction'
        db.add_column(u'cartmanager_collectionaddress', 'street_direction',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CollectionAddress.direction'
        db.delete_column(u'cartmanager_collectionaddress', 'direction')

        # Adding field 'InventoryAddress.street_direction'
        db.add_column(u'cartmanager_inventoryaddress', 'street_direction',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InventoryAddress.direction'
        db.delete_column(u'cartmanager_inventoryaddress', 'direction')
