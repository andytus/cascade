...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CartType', fields ['name', 'size']
        db.create_unique(u'cartmanager_carttype', ['name', 'size'])


        # Changing field 'CollectionAddress.zipcode'
        db.alter_column(u'cartmanager_collectionaddress', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'InventoryAddress.zipcode'
        db.alter_column(u'cartmanager_inventoryaddress', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        # Adding unique constraint on 'Route', fields ['route_type', 'route', 'route_day']
        db.create_unique(u'cartmanager_route', ['route_type', 'route', 'route_day'])


    def backwards(self, orm):
        # Removing unique constraint on 'Route', fields ['route_type', 'route', 'route_day']
        db.delete_unique(u'cartmanager_route', ['route_type', 'route', 'route_day'])

        # Removing unique constraint on 'CartType', fields ['name', 'size']
        db.delete_unique(u'cartmanager_carttype', ['name', 'size'])


        # Changing field 'CollectionAddress.zipcode'
        db.alter_column(u'cartmanager_collectionaddress', 'zipcode', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'InventoryAddress.zipcode'
        db.alter_column(u'cartmanager_inventoryaddress', 'zipcode', self.gf('django.db.models.fields.IntegerField')(default=0))
