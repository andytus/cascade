...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketsCompleteUploadFile.unsuccessful'
        db.add_column('cartmanager_ticketscompleteuploadfile', 'unsuccessful',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketsCompleteUploadFile.unsuccessful'
        db.delete_column('cartmanager_ticketscompleteuploadfile', 'unsuccessful')
