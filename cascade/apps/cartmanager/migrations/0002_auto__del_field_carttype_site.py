...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartType.site'
        db.delete_column('cartmanager_carttype', 'site_id')

        # Adding M2M table for field site on 'CartType'
        db.create_table('cartmanager_carttype_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('carttype', models.ForeignKey(orm['cartmanager.carttype'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('cartmanager_carttype_site', ['carttype_id', 'site_id'])


    def backwards(self, orm):
        # Adding field 'CartType.site'
        db.add_column('cartmanager_carttype', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Removing M2M table for field site on 'CartType'
        db.delete_table('cartmanager_carttype_site')
