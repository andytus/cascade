...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cartmanager_cart', 'current_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cartmanager.CartStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.current_status'
        db.delete_column('cartmanager_cart', 'current_status_id')
