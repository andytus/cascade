...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollectionAddress.unit'
        db.alter_column(u'cartmanager_collectionaddress', 'unit', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'InventoryAddress.unit'
        db.alter_column(u'cartmanager_inventoryaddress', 'unit', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'CollectionAddress.unit'
        db.alter_column(u'cartmanager_collectionaddress', 'unit', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

        # Changing field 'InventoryAddress.unit'
        db.alter_column(u'cartmanager_inventoryaddress', 'unit', self.gf('django.db.models.fields.CharField')(default='', max_length=15))
