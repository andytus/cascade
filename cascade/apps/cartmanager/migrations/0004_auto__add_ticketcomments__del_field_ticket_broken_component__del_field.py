...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TicketComments'
        db.create_table('cartmanager_ticketcomments', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('cartmanager', ['TicketComments'])

        # Deleting field 'Ticket.broken_component'
        db.delete_column('cartmanager_ticket', 'broken_component')

        # Deleting field 'Ticket.comments'
        db.delete_column('cartmanager_ticket', 'comments')


    def backwards(self, orm):
        # Deleting model 'TicketComments'
        db.delete_table('cartmanager_ticketcomments')

        # Adding field 'Ticket.broken_component'
        db.add_column('cartmanager_ticket', 'broken_component',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ticket.comments'
        db.add_column('cartmanager_ticket', 'comments',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)
