...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketComments.created_by'
        db.add_column('cartmanager_ticketcomments', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketComments.created_by'
        db.delete_column('cartmanager_ticketcomments', 'created_by_id')
