...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartServiceType.site'
        db.delete_column('cartmanager_cartservicetype', 'site_id')

        # Adding M2M table for field site on 'CartServiceType'
        db.create_table('cartmanager_cartservicetype_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cartservicetype', models.ForeignKey(orm['cartmanager.cartservicetype'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('cartmanager_cartservicetype_site', ['cartservicetype_id', 'site_id'])

        # Deleting field 'CartStatus.site'
        db.delete_column('cartmanager_cartstatus', 'site_id')

        # Adding M2M table for field site on 'CartStatus'
        db.create_table('cartmanager_cartstatus_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cartstatus', models.ForeignKey(orm['cartmanager.cartstatus'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('cartmanager_cartstatus_site', ['cartstatus_id', 'site_id'])

        # Deleting field 'TicketStatus.site'
        db.delete_column('cartmanager_ticketstatus', 'site_id')

        # Adding M2M table for field site on 'TicketStatus'
        db.create_table('cartmanager_ticketstatus_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ticketstatus', models.ForeignKey(orm['cartmanager.ticketstatus'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('cartmanager_ticketstatus_site', ['ticketstatus_id', 'site_id'])


    def backwards(self, orm):
        # Adding field 'CartServiceType.site'
        db.add_column('cartmanager_cartservicetype', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Removing M2M table for field site on 'CartServiceType'
        db.delete_table('cartmanager_cartservicetype_site')

        # Adding field 'CartStatus.site'
        db.add_column('cartmanager_cartstatus', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Removing M2M table for field site on 'CartStatus'
        db.delete_table('cartmanager_cartstatus_site')

        # Adding field 'TicketStatus.site'
        db.add_column('cartmanager_ticketstatus', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Removing M2M table for field site on 'TicketStatus'
        db.delete_table('cartmanager_ticketstatus_site')
