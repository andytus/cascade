...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TicketsCompleteUploadFile.unsucessful'
        db.delete_column('cartmanager_ticketscompleteuploadfile', 'unsucessful')


    def backwards(self, orm):
        # Adding field 'TicketsCompleteUploadFile.unsucessful'
        db.add_column('cartmanager_ticketscompleteuploadfile', 'unsucessful',
