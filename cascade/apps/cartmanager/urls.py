...
from cascade.apps.cartmanager.views import CartUploadView, DataErrorsView, CustomerUploadView, TicketSearchAPI, TicketsCompletedUploadView, \
      ...
      TicketStatusAPI, TicketCommentAPI, TicketServiceTypeAPI, FileUploadListAPI, FileUploadListView
...
urlpatterns = patterns('cascade.apps.cartmanager.views',
    ...
    url(r'^api/upload/files/', FileUploadListAPI.as_view(), name='upload_file_list_api'),
    url(r'^app/upload/files/$', FileUploadListView.as_view(), name='upload_file_list' ),
